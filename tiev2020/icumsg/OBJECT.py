...
from icumsg.BOUNDINGBOX import BOUNDINGBOX as icumsg_BOUNDINGBOX
...
class OBJECT(object):
    ...
    def __init__(self):
        ...
        self.width = 0.0
        self.length = 0.0
        self.corners = icumsg_BOUNDINGBOX()
        self.pathNum = 0
        self.path = []
    ...
    def _encode_one(self, buf):
        ...
        assert self.corners._get_packed_fingerprint() == icumsg_BOUNDINGBOX._get_packed_fingerprint()
        self.corners._encode_one(buf)
        buf.write(struct.pack(">b", self.pathNum))
        for i0 in range(self.pathNum):
            assert self.path[i0]._get_packed_fingerprint() == icumsg_POSITION._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.corners = icumsg_BOUNDINGBOX._decode_one(buf)
        self.pathNum = struct.unpack(">b", buf.read(1))[0]
        self.path = []
        for i0 in range(self.pathNum):
            self.path.append(icumsg_POSITION._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xa6a3e30c8bc83649+ icumsg_BOUNDINGBOX._get_hash_recursive(newparents)+ icumsg_POSITION._get_hash_recursive(newparents)) & 0xffffffffffffffff
