...
from icumsg.namedMapArray import namedMapArray as icumsg_namedMapArray

from icumsg.namedBoolArray import namedBoolArray as icumsg_namedBoolArray

from icumsg.namedIntArray import namedIntArray as icumsg_namedIntArray

from icumsg.namedDoubleArray import namedDoubleArray as icumsg_namedDoubleArray

from icumsg.namedFloatArray import namedFloatArray as icumsg_namedFloatArray
...
class structVISUALINFO(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.doubleArraySize):
            assert self.doubleArray[i0]._get_packed_fingerprint() == icumsg_namedDoubleArray._get_packed_fingerprint()
            self.doubleArray[i0]._encode_one(buf)
        buf.write(struct.pack(">h", self.floatArraySize))
        for i0 in range(self.floatArraySize):
            assert self.floatArray[i0]._get_packed_fingerprint() == icumsg_namedFloatArray._get_packed_fingerprint()
            self.floatArray[i0]._encode_one(buf)
        buf.write(struct.pack(">h", self.intArraySize))
        for i0 in range(self.intArraySize):
            assert self.intArray[i0]._get_packed_fingerprint() == icumsg_namedIntArray._get_packed_fingerprint()
            self.intArray[i0]._encode_one(buf)
        buf.write(struct.pack(">h", self.boolArraySize))
        for i0 in range(self.boolArraySize):
            assert self.boolArray[i0]._get_packed_fingerprint() == icumsg_namedBoolArray._get_packed_fingerprint()
            self.boolArray[i0]._encode_one(buf)
        buf.write(struct.pack(">h", self.mapArraySize))
        for i0 in range(self.mapArraySize):
            assert self.mapArray[i0]._get_packed_fingerprint() == icumsg_namedMapArray._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.doubleArray = []
        for i0 in range(self.doubleArraySize):
            self.doubleArray.append(icumsg_namedDoubleArray._decode_one(buf))
        self.floatArraySize = struct.unpack(">h", buf.read(2))[0]
        self.floatArray = []
        for i0 in range(self.floatArraySize):
            self.floatArray.append(icumsg_namedFloatArray._decode_one(buf))
        self.intArraySize = struct.unpack(">h", buf.read(2))[0]
        self.intArray = []
        for i0 in range(self.intArraySize):
            self.intArray.append(icumsg_namedIntArray._decode_one(buf))
        self.boolArraySize = struct.unpack(">h", buf.read(2))[0]
        self.boolArray = []
        for i0 in range(self.boolArraySize):
            self.boolArray.append(icumsg_namedBoolArray._decode_one(buf))
        self.mapArraySize = struct.unpack(">h", buf.read(2))[0]
        self.mapArray = []
        for i0 in range(self.mapArraySize):
            self.mapArray.append(icumsg_namedMapArray._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc306f6517fcd6306+ icumsg_namedDoubleArray._get_hash_recursive(newparents)+ icumsg_namedFloatArray._get_hash_recursive(newparents)+ icumsg_namedIntArray._get_hash_recursive(newparents)+ icumsg_namedBoolArray._get_hash_recursive(newparents)+ icumsg_namedMapArray._get_hash_recursive(newparents)) & 0xffffffffffffffff
