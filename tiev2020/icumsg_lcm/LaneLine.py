...
class LaneLine(object):
    ...
    __typenames__ = ["int32_t", "float", "int32_t", "icumsg_lcm.LinePoint"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num):
            assert self.points[i0]._get_packed_fingerprint() == icumsg_lcm.LinePoint._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.points = []
        for i0 in range(self.num):
            self.points.append(icumsg_lcm.LinePoint._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xa0e1d18725221fb+ icumsg_lcm.LinePoint._get_hash_recursive(newparents)) & 0xffffffffffffffff
