...
class structESRMAP(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(structESRMAP._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != structESRMAP._get_packed_fingerprint():
            raise ValueError("Decode error")
        return structESRMAP._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if structESRMAP in parents: return 0
        tmphash = (0x7061ca81d0470321) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if structESRMAP._packed_fingerprint is None:
            structESRMAP._packed_fingerprint = struct.pack(">Q", structESRMAP._get_hash_recursive([]))
        return structESRMAP._packed_fingerprint
