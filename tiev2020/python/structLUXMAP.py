...
class structLUXMAP(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(structLUXMAP._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != structLUXMAP._get_packed_fingerprint():
            raise ValueError("Decode error")
        return structLUXMAP._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if structLUXMAP in parents: return 0
        tmphash = (0xa054e842c438d804) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if structLUXMAP._packed_fingerprint is None:
            structLUXMAP._packed_fingerprint = struct.pack(">Q", structLUXMAP._get_hash_recursive([]))
        return structLUXMAP._packed_fingerprint
