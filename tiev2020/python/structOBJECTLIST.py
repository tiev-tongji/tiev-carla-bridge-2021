...
class structOBJECTLIST(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.count):
            assert self.obj[i0]._get_packed_fingerprint() == OBJECT._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.obj = []
        for i0 in range(self.count):
            self.obj.append(OBJECT._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc1fea086499ed5d+ OBJECT._get_hash_recursive(newparents)) & 0xffffffffffffffff
