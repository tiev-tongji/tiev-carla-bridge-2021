...
class structPARKINGSLOTS(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num):
            assert self.parking_slots[i0]._get_packed_fingerprint() == Slot._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.parking_slots = []
        for i0 in range(self.num):
            self.parking_slots.append(Slot._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xe3581b301de05f34+ Slot._get_hash_recursive(newparents)) & 0xffffffffffffffff
