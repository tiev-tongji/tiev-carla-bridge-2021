...
class structVLPMAP(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(structVLPMAP._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != structVLPMAP._get_packed_fingerprint():
            raise ValueError("Decode error")
        return structVLPMAP._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if structVLPMAP in parents: return 0
        tmphash = (0x86a86c4647910e85) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if structVLPMAP._packed_fingerprint is None:
            structVLPMAP._packed_fingerprint = struct.pack(">Q", structVLPMAP._get_hash_recursive([]))
        return structVLPMAP._packed_fingerprint
